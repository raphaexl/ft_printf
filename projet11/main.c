...
int main(void)
{
	...
	//double	val = 0;
//	double	val = NAN;
	long double	val2 = LDBL_MIN;
//	float	val2 = 0.6005500000000000000000000000000000000000079769;
	//double			valf = 3.40282e+38;
	//double			val = 7.31960296494528966981362954694E-304;
//	 double		val2 = 5.5626846514486572442618911564E-309;
//	uint_t	val2 = 8989652332348861589;
	//d.d = val;
	//char	*val = "hello World";
	//printf("\n--------Lf-------\n");
//	printf("----ft_printf--\n");`
	int n1 = ft_printf("ft_printf : %-+12.16000Lf\n",val2);
	int n2 = printf("printf    : %+-12.16000Lf\n", val2);
	printf("Result : %d\n %d\n", n1, n2);
/* 	   printf("|%- .35d|\n", -54687);
  	ft_printf("|%- .35d|\n\n", -54687);
  	   printf("|%- .32d|\n", 54687);
